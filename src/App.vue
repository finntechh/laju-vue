        ...
        <div class="nav-dropdown-menu" v-show="navDropdownMenu">
          <ul class="nav-dropdown-list">
            <li class="nav-dropdown-item">
              <router-link @click="toggleDropdown" class="nav-dropdown-link" to="/">Home</router-link>
            </li>
            <li class="nav-dropdown-item">
              <router-link @click="toggleDropdown" class="nav-dropdown-link" to="/News">News</router-link>
            </li>
            <li class="nav-dropdown-item">
              <router-link @click="toggleDropdown" class="nav-dropdown-link" to="/Über-uns">Über uns</router-link>
            </li>
            <li class="nav-dropdown-item">
              <router-link @click="toggleDropdown" class="nav-dropdown-link" to="/Kontakt">Kontakt</router-link>
            </li>
          </ul>
        </div>
          ...
          <div class="footer-email">
            ...
            <h2>
              Komm bei uns vorbei, jeden Mittwoch ab <span
                style="cursor: pointer; :hover {color: var(--accent)};">20Uhr</span> im Landjugendkeller
            </h2>
          </div>
        </div>
      </div>
